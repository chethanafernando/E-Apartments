...
{
    public class LeaseAgreementClass
    {
        public int LA_ID { get; set; }

        public DateTime LA_StartDate { get; set; }

        public DateTime LA_EndDate { get; set; }

        public string LA_Duration { get; set; }

        public decimal LA_AdvancePayment { get; set; }

        public bool LA_IsRefunded { get; set; }

        public bool LA_Removed { get; set; }
